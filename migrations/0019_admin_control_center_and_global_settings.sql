...
-- SEO & LLMs
('seo_title_template', '{{page_title}} | Psychology Calculator', 'string', 1, 'Global title template'),
...
('pdf_reports', 'Vector PDF Report Downloads', 'Enables generation and downloading of branded high-resolution PDF results', 0),
