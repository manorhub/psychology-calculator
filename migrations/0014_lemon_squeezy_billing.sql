...
('monetization', 'Monetization & Subscriptions', 'Enables paid subscription plans and checkout redirects', 1),
('annual_discount_banner', 'Annual Discount Callout', 'Displays 33% off savings badge on annual pricing tier', 1);
