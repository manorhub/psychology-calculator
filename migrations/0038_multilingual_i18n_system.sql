...
-- 10. Add report_locale column to reports and locale to assessment_attempts if not present
-- Note: SQLite allows adding columns safely
ALTER TABLE reports ADD COLUMN report_locale TEXT DEFAULT 'en';
...
VALUES
    -- Openness
    ('trans_dim_open_es', 'dim_openness', 'es', 'Apertura a la Experiencia', 'Mide la curiosidad intelectual, la imaginación creativa y la disposición hacia nuevas ideas.'),
    ('trans_dim_open_fr', 'dim_openness', 'fr', 'Ouverture à l''Expérience', 'Mesure la curiosité intellectuelle, l''imagination créative et la réceptivité aux idées nouvelles.'),
    ('trans_dim_open_de', 'dim_openness', 'de', 'Offenheit für Erfahrungen', 'Erfasst intellektuelle Neugier, kreative Vorstellungskraft und Bereitschaft für neue Perspektiven.'),
    ('trans_dim_open_pt', 'dim_openness', 'pt', 'Abertura à Experiência', 'Mede a curiosidade intelectual, imaginação criativa e receptividade a novas ideias e experiências.'),
    ('trans_dim_open_hi', 'dim_openness', 'hi', 'अनुभव के प्रति खुलापन', 'बौद्धिक जिज्ञासा, रचनात्मक कल्पना और नए विचारों के प्रति ग्रहणशीलता को मापता है।'),

    -- Conscientiousness
    ('trans_dim_consc_es', 'dim_conscientiousness', 'es', 'Responsabilidad y Autodisciplina', 'Evalúa la organización personal, la perseverancia orientada a metas y el autocontrol.'),
    ('trans_dim_consc_fr', 'dim_conscientiousness', 'fr', 'Conscience Professionnelle', 'Évalue l''organisation personnelle, la persévérance vers les objectifs et la maîtrise de soi.'),
    ('trans_dim_consc_de', 'dim_conscientiousness', 'de', 'Gewissenhaftigkeit & Disziplin', 'Misst Zielorientierung, Selbstorganisation, Zuverlässigkeit und strukturierte Arbeitsweise.'),
    ('trans_dim_consc_pt', 'dim_conscientiousness', 'pt', 'Conscienciosidade e Disciplina', 'Avalia a organização pessoal, persistência focada em metas e autocontrole.'),
    ('trans_dim_consc_hi', 'dim_conscientiousness', 'hi', 'कर्तव्यनिष्ठा और आत्म-अनुशासन', 'व्यक्तिगत संगठन, लक्ष्य-उन्मुख दृढ़ता और आत्म-नियंत्रण का मूल्यांकन करता है।'),

    -- Extraversion
    ('trans_dim_ext_es', 'dim_extraversion', 'es', 'Extraversión y Energía Social', 'Mide el entusiasmo en interacciones sociales, la asertividad y la búsqueda de estímulos externos.'),
    ('trans_dim_ext_fr', 'dim_extraversion', 'fr', 'Extraversion et Énergie Sociale', 'Mesure l''enthousiasme dans les interactions sociales, l''assertivité et l''énergie relationnelle.'),
    ('trans_dim_ext_de', 'dim_extraversion', 'de', 'Extraversion & Soziale Energie', 'Erfasst Begeisterungsfähigkeit im sozialen Kontakt, Durchsetzungsstärke und Kontaktfreude.'),
    ('trans_dim_ext_pt', 'dim_extraversion', 'pt', 'Extroversão e Energia Social', 'Mede o entusiasmo nas relações sociais, assertividade e busca por estímulos sociais.'),
    ('trans_dim_ext_hi', 'dim_extraversion', 'hi', 'बहिर्मुखता और सामाजिक ऊर्जा', 'सामाजिक संपर्कों में उत्साह, मुखरता और बाहरी उत्तेजनाओं की तलाश को मापता है।'),

    -- Agreeableness
    ('trans_dim_agr_es', 'dim_agreeableness', 'es', 'Amabilidad y Empatía', 'Examina la disposición prosocial, la confianza interpersonal y la orientación a la cooperación.'),
    ('trans_dim_agr_fr', 'dim_agreeableness', 'fr', 'Agréabilité et Empathie', 'Examine les dispositions prosociales, la confiance envers autrui et l''orientation vers la coopération.'),
    ('trans_dim_agr_de', 'dim_agreeableness', 'de', 'Verträglichkeit & Empathie', 'Untersucht Kooperationsbereitschaft, zwischenmenschliches Vertrauen und Hilfsbereitschaft.'),
    ('trans_dim_agr_pt', 'dim_agreeableness', 'pt', 'Amabilidade e Empatia', 'Examina a conduta pró-social, confiança interpessoal e predisposição para cooperação.'),
    ('trans_dim_agr_hi', 'dim_agreeableness', 'hi', 'सहमतता और सहानुभूति', 'सामाजिक सहयोग, पारस्परिक विश्वास और दूसरों की भलाई के प्रति झुकाव की जांच करता है।'),

    -- Neuroticism / Emotional Stability
    ('trans_dim_neur_es', 'dim_neuroticism', 'es', 'Sensibilidad Emocional (Neuroticismo)', 'Evalúa la tendencia a experimentar respuestas emocionales intensas ante situaciones de estrés o incertidumbre.'),
    ('trans_dim_neur_fr', 'dim_neuroticism', 'fr', 'Sensibilité Émotionnelle (Névrosisme)', 'Évalue la propension à ressentir des émotions intenses face au stress ou à l''incertitude.'),
    ('trans_dim_neur_de', 'dim_neuroticism', 'de', 'Emotionale Sensibilität (Neurotizismus)', 'Erfasst die emotionale Reaktionsstärke auf Stressfaktoren und Herausforderungen im Alltag.'),
    ('trans_dim_neur_pt', 'dim_neuroticism', 'pt', 'Sensibilidade Emocional (Neuroticismo)', 'Avalia a propensão a vivenciar reações emocionais intensas sob estresse ou incerteza.'),
    ('trans_dim_neur_hi', 'dim_neuroticism', 'hi', 'भावनात्मक संवेदनशीलता (मनोविक्षुब्धता)', 'तनाव या अनिश्चितता के प्रति भावनात्मक प्रतिक्रियाशीलता का आकलन करता है।')
