...
CREATE UNIQUE INDEX IF NOT EXISTS idx_gen_files_attempt_type ON generated_files(attempt_id, file_type) WHERE attempt_id IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_gen_files_report_type ON generated_files(report_id, file_type) WHERE report_id IS NOT NULL;
