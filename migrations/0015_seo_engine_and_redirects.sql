...
('link_1', 'assessment', 'asm_big_five', 'assessment', 'asm_myers_briggs_type', 'Explore 16 Personality Types Assessment', 1, 1),
('link_2', 'assessment', 'asm_big_five', 'assessment', 'asm_emotional_intelligence', 'Evaluate Your Emotional Intelligence (EQ)', 2, 1),
('link_3', 'assessment', 'asm_attachment_style', 'assessment', 'asm_love_languages', 'Discover Your Primary Love Language', 1, 1),
('link_4', 'assessment', 'asm_anxiety_screening', 'assessment', 'asm_depression_screening', 'Take the PHQ-9 Depression Inventory', 1, 1);
