...
('rc_bf_1', 'rt_openness_high', 'overview', 'Comprehensive Cognitive Profile', 'You show an exceptional degree of intellectual curiosity and artistic or philosophical appreciation. You naturally question conventional constraints and generate innovative hypotheses.', 1),
('rc_bf_2', 'rt_openness_high', 'strengths', 'Key Cognitive Strengths', '• Strong abstract reasoning and divergent ideation\n• Receptivity to novel cultural and intellectual perspectives\n• Agility in ambiguous, rapidly evolving problem spaces', 2),
('rc_bf_3', 'rt_openness_high', 'growth_suggestions', 'Strategic Growth Suggestions', 'Pair your expansive conceptual brainstorms with systematic execution milestones to ensure ideas become concrete reality.', 3);
