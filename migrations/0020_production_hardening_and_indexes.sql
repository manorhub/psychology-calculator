...
CREATE INDEX IF NOT EXISTS idx_assessment_attempts_user_status ON assessment_attempts(user_id, status, completed_at DESC);
CREATE INDEX IF NOT EXISTS idx_assessment_attempts_guest_status ON assessment_attempts(guest_session_id, status);
...
CREATE INDEX IF NOT EXISTS idx_payment_transactions_user_status ON payment_transactions(user_id, status, created_at DESC);
