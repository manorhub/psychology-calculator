...
export class PdfDocumentBuilder {
  ...
  public addHeader(categoryName = 'PSYCHOLOGICAL EVALUATION', assessmentName?: string): void {
    ...
    const rightText = assessmentName ? `${categoryName} • ${assessmentName}` : this.theme.brandDomain!;
  ...
  public addCoverHeader(
    ...
    this.currentPage.drawText('OFFICIAL PSYCHOMETRIC DOSSIER', {
      x: this.marginX + 8,
      y: this.cursorY - 13,
      size: 7.5,
      font: this.boldFont,
    ...
    this.currentPage.drawText('PRIMARY PSYCHOLOGICAL CLASSIFICATION', {
      x: this.marginX + 105,
      y: this.cursorY - 22,
      size: 8,
      font: this.boldFont,
