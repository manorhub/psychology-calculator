...
import { FeatureService } from '../src/services/features/feature.service.js';
...
async function runTests() {
  ...
  assert.strictEqual((publicSettings as any).smtp_password, undefined, 'Secrets must never exist in public settings');
