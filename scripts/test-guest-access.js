...
async function runTests() {
  ...
  const settings = await settingsService.getGroupSettings('assessments');
  ...
  await settingsService.updateSetting('guest_assessments_enabled', 'false', 'admin_1');
  ...
  // Re-enable
  await settingsService.updateSetting('guest_assessments_enabled', 'true', 'admin_1');
