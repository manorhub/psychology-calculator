...
async function runTests() {
  ...
  rawDb.prepare("INSERT INTO analytics_events (id, event_name, entity_type, path, user_id, created_at) VALUES ('ev1', 'page_view', 'page', '/assessments/big-five-personality-test', 'u1', ?)").run(dateStr);
  rawDb.prepare("INSERT INTO analytics_events (id, event_name, entity_type, path, user_id, created_at) VALUES ('ev2', 'assessment_view', 'assessment', '/assessments/big-five-personality-test', 'u1', ?)").run(dateStr);
  rawDb.prepare("INSERT INTO analytics_events (id, event_name, entity_type, user_id, created_at) VALUES ('ev3', 'result_view', 'result', 'u1', ?)").run(dateStr);
  rawDb.prepare("INSERT INTO analytics_events (id, event_name, entity_type, user_id, created_at) VALUES ('ev4', 'checkout_start', 'pricing', 'u1', ?)").run(dateStr);
  ...
  rawDb.prepare("INSERT INTO ai_generations (id, attempt_id, user_id, status, model_used, total_tokens, estimated_cost_usd, content_json, created_at) VALUES ('ai_growth_1', 'att_growth_1', 'u1', 'completed', 'gemini-1.5-flash', 500, 0.0005, '{}', ?)").run(dateStr);
