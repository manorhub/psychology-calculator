...
async function runTests() {
  ...
  assert(compiled.html.includes('https://psychologycalculator.com/privacy-policy'), 'HTML should include Privacy Policy');
  assert(compiled.html.includes('https://psychologycalculator.com/terms-of-service'), 'HTML should include Terms of Service');
  assert(compiled.html.includes('https://psychologycalculator.com/disclaimer'), 'HTML should include Psychological Disclaimer');
  ...
  assert(compiled.text.includes('[Explore Assessments]: https://psychologycalculator.com/dashboard'), 'Text should contain clean CTA button format');
