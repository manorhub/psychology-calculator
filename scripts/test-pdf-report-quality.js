...
async function runQualityTests() {
  ...
  let assessmentSlug = 'attachment-style-test';
  let assessmentObj = await runtimeService.getPublishedAssessmentBySlug(assessmentSlug);
  if (!assessmentObj) {
    assessmentSlug = 'big-five-personality-test';
    assessmentObj = await runtimeService.getPublishedAssessmentBySlug(assessmentSlug);
  }
